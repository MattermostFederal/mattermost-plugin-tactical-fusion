...
const (
	...
	SectionFeatures   SectionID = "features"
	SectionProperties SectionID = "properties"
...
// that decides which ids the server will store; geojson_sync_test.go holds the
...
var Sections = []Section{
	{SectionMap, "Map"},
	{SectionSummary, "What the document holds"},
	{SectionFeatures, "Features"},
	{SectionProperties, "Feature properties"},
