...
var agentPrompts = []agentPrompt{
	...
	{"Cursor on Target", "Create a hostile ground CoT event named TGT01 at PHIK in Hawaii with a 25 m circular error that goes stale in 30 minutes, and post it."},
	{"GeoJSON", "Create GeoJSON with a red 25 m circle centered on PHIK in Hawaii and a green line from PHIK to PGUM in Guam, and post it."},
