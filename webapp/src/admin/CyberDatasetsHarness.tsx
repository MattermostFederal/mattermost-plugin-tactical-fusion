...
const LOADED = {
    ...
    datasets: [
        {name: 'cve', label: 'vulnerability', path: '/mattermost/data/cyber-datasets/cve.tsv', kind: 'configured', size: 185738016, records: 396474, countError: '', generated: '2026-09-23T20:57:13Z', source: 'nvd'},
        {name: 'kev', label: 'known exploited vulnerabilities', path: '/plugins/tactical-fusion/assets/cyber/kev.tsv', kind: 'bundled', size: 276258, records: 1721, countError: '', generated: '2026-09-24T01:00:44Z', source: 'CISA KEV catalog 2026.09.23'},
    ],
    databases: [
