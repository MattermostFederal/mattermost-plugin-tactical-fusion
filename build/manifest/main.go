...
func applyManifest(manifest *model.Manifest) error {
	...
	if manifest.HasWebapp() {
		...
		// Escape backslashes for JS template literal embedding.
		// The JSON is wrapped in backticks and parsed via JSON.parse(),
		// so all backslash sequences must be doubled to survive the
		// template literal processing step.
